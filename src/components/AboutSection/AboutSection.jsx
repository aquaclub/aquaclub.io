...
const AboutSection = () => {
  return (
    <section
      id='about'
      style={{
        backgroundImage: `linear-gradient(180deg, rgba(255, 255, 255, 0) 0%, rgba(255, 255, 255, 0.6) 10%, rgba(255, 255, 255, 0.4) 95%, rgba(255, 255, 255, 0) 100%), url("${sectionBackground}")`
      }}
    >
      <div className='container'>
        <div className='about-wrapper'>
          ...
          <p className='about-wrapper__paragraph'>
            The intricate evolution of these creatures, the classification of
            which is analogous to the classification of holders as ranging from
            “shrimps” to “whales”, mimics the hybrid human/cypher identities we
            are all developing as we delve deeper into the metaverse.
          </p>
          <p className='about-wrapper__paragraph'>
          ...
          <p className='about-wrapper__paragraph'>
            ...
            inclusiveness, and humor are paramount.
          </p>
          <p className='about-wrapper__paragraph'>
